...
public class FindAllCommandTest {
    ...
    @DataProvider
    public static Object[][] executeFindAll() {
    ...
    @Test(dataProvider = "executeFindAll")
    public void testExecuteFindAll(Map<String, String> request, Map<String, Object> expectedResult) {
        Map<String, Object> actual = findAllCommand.execute(request);
